      ...
      <div class="lg:col-span-3">
        <div class="bg-white rounded-2xl p-8" style="border: 1px solid #dde8e5;">
          ...
          <div class="flex items-center gap-2 mb-1">
            <div class="w-4 h-4 rounded-sm" style="background: linear-gradient(135deg, #6FC061, #2A9D93);"></div>
            <h2 class="text-xl font-bold" style="color: #162525;">Send a Project Inquiry</h2>
          </div>
          <p class="text-sm mb-7" style="color: #585858;">All fields marked * are required.</p>
          ...
          <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST" class="flex flex-col gap-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Full Name *</label>
                <input type="text" name="full_name" required
                       class="w-full rounded-lg px-4 py-3 text-sm outline-none transition-colors duration-200"
                       style="background: #F1F6F2; border: 1px solid #dde8e5; color: #162525;"
                       placeholder="John Smith"
                       onfocus="this.style.borderColor='#2A9D93'; this.style.background='#fff'"
                       onblur="this.style.borderColor='#dde8e5'; this.style.background='#F1F6F2'">
              </div>
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Company Name *</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Phone Number *</label>
              ...
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Email Address *</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Project Type *</label>
                <div class="relative">
                  <select name="project_type" required
                          class="w-full rounded-lg px-4 py-3 text-sm outline-none transition-colors duration-200 appearance-none cursor-pointer"
                          style="background: #F1F6F2; border: 1px solid #dde8e5; color: #162525;"
                          onfocus="this.style.borderColor='#2A9D93'"
                          onblur="this.style.borderColor='#dde8e5'">
                  ...
                  <div class="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                    <svg class="w-4 h-4" style="color: #585858;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Project State *</label>
                <div class="relative">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Project Timeline</label>
                <div class="relative">
            ...
            <!-- Trade Scope Checkboxes -->
            <div>
              <label class="block text-xs font-semibold mb-3" style="color: #162525;">Trade Scope Needed</label>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                foreach ($trades as $trade) : ?>
                  <label class="ig-checkbox-label flex items-center gap-3 rounded-lg px-4 py-3 cursor-pointer transition-all duration-150"
                         style="border: 1px solid #dde8e5; background: #F1F6F2;">
                    <input type="checkbox" name="trades[]" value="<?php echo esc_attr($trade['value']); ?>"
                           class="ig-checkbox w-4 h-4 cursor-pointer flex-shrink-0"
                           style="accent-color: #2A9D93;">
                    <span class="text-sm" style="color: #585858;"><?php echo esc_html($trade['label']); ?></span>
                  </label>
                <?php endforeach; ?>
              </div>
            </div>
            ...
            <!-- Additional Info -->
            <div>
              <label class="block text-xs font-semibold mb-1.5" style="color: #162525;">Additional Information</label>
              <textarea name="message" rows="4"
                        class="w-full rounded-lg px-4 py-3 text-sm outline-none transition-colors duration-200 resize-none"
                        style="background: #F1F6F2; border: 1px solid #dde8e5; color: #162525;"
                        placeholder="Briefly describe your project scope, timeline, or any other details…"
                        onfocus="this.style.borderColor='#2A9D93'; this.style.background='#fff'"
                        onblur="this.style.borderColor='#dde8e5'; this.style.background='#F1F6F2'"></textarea>
            </div>

            <!-- Submit -->
            <div>
              <button type="submit"
                      class="w-full font-bold py-4 rounded-lg transition-all duration-200 text-sm tracking-wide flex items-center justify-center gap-2"
              ...
              <p class="text-center text-xs mt-3 flex items-center justify-center gap-1.5" style="color: #7fa89e;">
