<?php
/*
  Template Name: Service — Cabinet & Countertop Installation
*/
...
<section class="relative overflow-hidden" style="background-color: #162525; min-height: 72vh; display: flex; align-items: flex-end;">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 w-full">
    ...
    <div class="flex items-center gap-2 mb-8 text-xs" style="color: #4d7069;">
      ...
      <span style="color: #7fa89e;">Cabinet & Countertop Installation</span>
    </div>
    ...
    <div class="max-w-3xl">
      ...
      <div class="flex items-center gap-3 mb-5">
        <span class="font-bold text-5xl leading-none"
              style="background: linear-gradient(135deg, #6FC061, #2A9D93); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; opacity: 0.35;">02</span>
        ...
        <div class="inline-flex items-center gap-2 rounded-full px-3 py-1"
          ...
          <span class="text-xs font-semibold tracking-widest uppercase" style="color: #2A9D93;">Precision-Driven</span>
        </div>
      </div>
...
<!-- ============================================================
     SERVICE OVERVIEW + EXECUTION STANDARD
     ============================================================ -->
<section class="py-16 lg:py-20" style="background-color: #F1F6F2;">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-start">
      ...
      <!-- Execution standard + Operational notes -->
      <div class="flex flex-col gap-5">
        ...
        <div class="grid grid-cols-2 gap-4">
          <?php
          $ops = [
            ['label' => 'Materials',    'value' => 'Corian countertops. Commercial casework per project spec.'],
            ['label' => 'Scope',        'value' => 'Installation only. We do not template or fabricate countertops.'],
            ['label' => 'Coordination', 'value' => 'Coordinates with plumbing and electrical rough-in sequencing.'],
            ['label' => 'Warranty',     'value' => '1 year on all completed installations.'],
          ];
          foreach ($ops as $op) : ?>
            <div class="bg-white rounded-xl p-5" style="border: 1px solid #dde8e5;">
              <div class="w-5 h-0.5 mb-2.5 rounded-full" style="background: linear-gradient(135deg, #6FC061, #2A9D93);"></div>
              <p class="text-xs font-semibold uppercase tracking-wide mb-1.5" style="color: #2A9D93;"><?php echo esc_html($op['label']); ?></p>
              <p class="text-xs leading-relaxed" style="color: #585858;"><?php echo esc_html($op['value']); ?></p>
            </div>
          <?php endforeach; ?>
        </div>
...
<section class="py-16 lg:py-20" style="background-color: #162525;">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
      ...
      $installs = [
        [
          'title' => 'Commercial Casework & Cabinet Systems',
          'desc'  => 'Full commercial cabinet installation for food service, healthcare, and office environments. Executed from project specifications with no deviation from the approved layout.',
        ...
        [
          'title' => 'Corian Countertop Installation',
          'desc'  => 'Precision cuts, seaming, and finishing of Corian countertop systems to commercial specification. Seam quality and surface finish are non-negotiable.',
        ...
        [
          'title' => 'Franchise Rollout Programs',
          'desc'  => 'Cabinet and countertop packages for multi-location franchise rollout programs requiring brand standard enforcement and repeatable results across every location.',
        ...
        [
          'title' => 'Multi-Unit Residential Packages',
          'desc'  => 'High-volume cabinet installation for multi-unit residential projects requiring consistent execution across every unit — same standard, same finish, every time.',
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 xl:gap-16">
      ...
      <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        $sectors = [
          ...
          [
            'title' => 'Corporate & Financial TI',
            'desc'  => 'High-specification office interiors for corporate tenants, financial institutions, and professional service environments requiring precision finish work.',
            'icon'  => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>',
          ],
          [
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <h2 class="text-3xl sm:text-4xl font-bold text-white leading-tight mb-4">
          Request a Cabinet & Countertop Scope Review.
        </h2>
        <p class="text-base leading-relaxed mb-6" style="color: #b8d4ce;">
          Imvera's dedicated installation crews are available across the Southeast. If you have an upcoming casework or Corian countertop scope, reach out. We respond within one business day.
        </p>
      ...
      <div class="rounded-2xl p-7" style="background: rgba(241,246,242,0.05); border: 1px solid rgba(241,246,242,0.1);">
        ...
        <?php
        $specs = [
          ['label' => 'Trade',          'value' => 'Cabinet & Countertop Installation'],
          ['label' => 'Materials',      'value' => 'Corian · Commercial casework'],
          ['label' => 'Scope',          'value' => 'Installation only (no fabrication)'],
          ['label' => 'Crew Type',      'value' => 'Dedicated — trade-specific'],
          ['label' => 'Coordination',   'value' => 'Plumbing & electrical sequencing'],
