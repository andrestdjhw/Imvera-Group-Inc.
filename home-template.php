...
<section class="relative min-h-screen flex items-stretch overflow-hidden" style="background-color: #162525;">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 w-full flex items-center">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 w-full items-center">
      ...
      <div class="rounded-2xl p-7 lg:p-8"
           style="background: rgba(241,246,242,0.04); backdrop-filter: blur(8px); border: 1px solid rgba(241,246,242,0.1);">
        <div class="flex items-center gap-2 mb-1">
          <div class="w-4 h-4 rounded-sm" style="background: linear-gradient(135deg, #6FC061, #2A9D93);"></div>
          <p class="text-xs font-semibold tracking-widest uppercase" style="color: #2A9D93;">Response Within 1 Business Day</p>
        </div>
        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST" class="flex flex-col gap-3.5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Full Name *</label>
              <input type="text" name="full_name" required
                     class="w-full rounded-lg px-4 py-3 text-white text-sm outline-none transition-colors duration-200"
                     style="background: rgba(241,246,242,0.06); border: 1px solid rgba(241,246,242,0.1);"
                     placeholder="John Smith"
                     onfocus="this.style.borderColor='rgba(42,157,147,0.6)'"
                     onblur="this.style.borderColor='rgba(241,246,242,0.1)'">
            </div>
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Company *</label>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Phone *</label>
            ...
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Email *</label>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Service Needed</label>
              <select name="service"
                      class="w-full rounded-lg px-4 py-3 text-sm outline-none transition-colors duration-200 appearance-none cursor-pointer"
                      style="background: #162525; border: 1px solid rgba(241,246,242,0.1); color: #b8d4ce;"
                      onfocus="this.style.borderColor='rgba(42,157,147,0.6)'"
                      onblur="this.style.borderColor='rgba(241,246,242,0.1)'">
            ...
            <div>
              <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">State</label>
              <select name="state"
                      class="w-full rounded-lg px-4 py-3 text-sm outline-none transition-colors duration-200 appearance-none cursor-pointer"
                      style="background: #162525; border: 1px solid rgba(241,246,242,0.1); color: #b8d4ce;"
                      onfocus="this.style.borderColor='rgba(42,157,147,0.6)'"
          ...
          <div>
            <label class="block text-xs font-medium mb-1.5" style="color: #7fa89e;">Message</label>
            <textarea name="message" rows="3"
                      class="w-full rounded-lg px-4 py-3 text-white text-sm outline-none transition-colors duration-200 resize-none"
                      style="background: rgba(241,246,242,0.06); border: 1px solid rgba(241,246,242,0.1);"
                      placeholder="Briefly describe your project scope…"
                      onfocus="this.style.borderColor='rgba(42,157,147,0.6)'"
                      onblur="this.style.borderColor='rgba(241,246,242,0.1)'"></textarea>
          </div>

          <button type="submit"
                  class="w-full font-bold py-3.5 rounded-lg transition-all duration-200 text-sm tracking-wide flex items-center justify-center gap-2"
                  style="background: linear-gradient(135deg, #6FC061, #2A9D93); color: #F1F6F2;"
                  onmouseover="this.style.opacity='0.88'"
                  onmouseout="this.style.opacity='1'">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
